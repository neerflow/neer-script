	...
	local function BuildMovementTab(parentFrame)
		...
		local NoclipCtrl = CreateSwitchCard(parentFrame, "No Clip Mode", function(active)
			NoclipCtrl.Card.BackgroundColor3 = Theme.ActiveTab; NoclipCtrl.Card.BackgroundTransparency = 0;
...
--// [BAGIAN 10] KONTEN TAB: TELEPORT (UPDATED NOTIF)
...
local function BuildVisualsTab(parentFrame)
    ...
    local function CreateSuperCamCard(parent, showTitleInside)
        ...
        if showTitleInside then
            local Title = Instance.new("TextLabel"); Title.Parent = Card; Title.BackgroundTransparency=1; Title.Position=UDim2.new(0,15,0,8); Title.Size=UDim2.new(1,-30,0,20); Title.Font=Theme.FontBold; Title.Text="Position & Mode"; Title.TextColor3=Theme.Text; Title.TextSize=14; Title.TextXAlignment=Enum.TextXAlignment.Left
        end
